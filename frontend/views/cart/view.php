...
'dae'	 => json_encode($session['cart'])
	...
	<?= $form->field($order, 'delivery')->dropDownList([ 'Новая почта: оплата онлайн' => 'Новая почта: оплата онлайн',
														 'Новая почта: наложенный платеж' => 'Новая почта: наложенный платеж',
														 'Новая почта: наличные' => 'Новая почта: наличные',
														 'Ин-тайм: оплата онлайн' => 'Ин-тайм: оплата онлайн',
														 'Ин-тайм: наложенный платеж' => 'Ин-тайм: наложенный платеж',
														 'Ин-тайм: наличные' => 'Ин-тайм: наличные',
														 'Автолюкс: оплата онлайн' => 'Автолюкс: оплата онлайн',
														 'Автолюкс: наложенный платеж' => 'Автолюкс: наложенный платеж',
														 'Автолюкс: наличные' => 'Автолюкс: наличные']) ?>
